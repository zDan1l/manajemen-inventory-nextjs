        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button onClick={() => { setShowUserMenu(!showUserMenu); setShowNotifications(false); }} className="flex items-center gap-3 p-2 hover:bg-gray-100 rounded-lg transition-colors">
              <div className="w-8 h-8 bg-gradient-to-br from-[#00A69F] to-[#0D9488] rounded-full flex items-center justify-center">
              ...
              <div className="text-left hidden sm:block">
                ...
                <p className="text-xs text-gray-500">{user?.nama_role || 'Role'}</p>
              </div>
