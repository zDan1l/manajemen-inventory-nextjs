  ...
  const handleUpdateDetail = (idbarang: number, jumlah: number) => {
    ...
    if (jumlah > item.sisa_diterima) {
      ...
      setDetails(
        details.map((d) =>
          d.idbarang === idbarang
            ? { ...d, jumlah_terima: item.sisa_diterima }
            : d
        )
      );
      return;
          ...
          <Card className="p-6">
            ...
            <div className="flex items-center justify-between mt-4 pt-4 border-t">
              <div className="text-sm text-gray-600">
                Menampilkan{" "}
                <span className="font-bold text-[#00A69F]">
                  {filteredPengadaans.length}
                </span>{" "}
                dari {pengadaans.length} pengadaan
              </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 text-lg mb-2">
                  {pengadaans.length === 0
                    ? "Tidak ada pengadaan yang belum lengkap"
                        ...
                        <div className="flex items-center gap-2">
                          <div className="flex-1 bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{
                                width: `${
                                  (p.items_lengkap / p.total_items) * 100
                                }%`,
                              }}
                            ></div>
                          </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 mt-0.5">
                      Penerima barang terisi otomatis sesuai akun yang login
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Tentukan jumlah barang yang diterima untuk setiap item
                </p>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                    ...
                    <th className="p-4 text-center text-sm font-semibold text-gray-700 border-b bg-teal-50">
                      Terima Kali Ini
                    </th>
                    <th className="p-4 text-right text-sm font-semibold text-gray-700 border-b bg-teal-50">
                      Subtotal
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {breakdown.map((item, idx) => {
                    ...
                    const subtotal =
                      (currentDetail?.jumlah_terima || 0) * item.harga_satuan;
                      ...
                      >
                        ...
                        <td className="p-4 text-right">
                          <span className="text-blue-600 font-medium">
                            {item.jumlah_sudah_diterima}
                          </span>
                        </td>
                        <td className="p-4 text-right">
                          <span
                            className={`font-bold ${
                              item.sisa_diterima > 0
                                ? "text-orange-600"
                                : "text-green-600"
                            }`}
                          >
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-xl p-4 shadow-sm">
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    {details.reduce(
                      (sum, d) => sum + (Number(d.jumlah_terima) || 0),
                      0
                    )}
                  </p>
                  ...
                  <p className="text-3xl font-bold text-[#00A69F]">
                    {formatCurrency(
                      breakdown.reduce((sum, item, idx) => {
                        return (
                          sum +
                          (details[idx]?.jumlah_terima || 0) * item.harga_satuan
                        );
                      }, 0)
                    )}
                  </p>
            ...
            <div className="flex gap-3">
              ...
              <Button
                ...
                disabled={
                  loading ||
                  !iduser ||
                  details.filter((d) => d.jumlah_terima > 0).length === 0
                }
